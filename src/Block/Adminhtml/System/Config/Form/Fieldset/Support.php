...
namespace MagePsycho\ProductAttachment\Block\Adminhtml\System\Config\Form\Fieldset;
...
class Support extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'MagePsycho_ProductAttachment::system/config/form/fieldset/support.phtml';
