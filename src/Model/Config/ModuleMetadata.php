...
namespace MagePsycho\ProductAttachment\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const MODULE_NAME = 'MagePsycho_ProductAttachment';

    const VERSION_CACHE_KEY = 'magepsycho-productattachment-module-version';
